/** * Top toolbar container component that combines tool selector, history controls, and zoom
controls. * Displays three independent floating modules in a single row. */
